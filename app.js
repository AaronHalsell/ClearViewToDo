    ...
    const toggleRedMode = document.querySelector('#toggle-red-mode')
    ...
    toggleDarkMode.addEventListener('click', () => {
        if (themeContainer.classList.contains('dark-mode')) {
            ...
            themeContainer.classList.add("blue-mode");
        }
        else {
            themeContainer.classList.remove("blue-mode");
            themeContainer.classList.remove("red-mode");
            themeContainer.classList.add("dark-mode");
            toggleDarkMode.classList.add("hidden");
            toggleBlueMode.classList.remove("hidden");
            toggleRedMode.classList.remove("hidden");
        }
  });

        toggleBlueMode.addEventListener('click', () => {
            if (themeContainer.classList.contains('blue-mode')) {
                themeContainer.classList.remove("blue-mode");
                themeContainer.classList.add("dark-mode");
            }
            else {
                ...
                themeContainer.classList.remove("red-mode");
                themeContainer.classList.add("blue-mode");
                toggleBlueMode.classList.add("hidden");
                toggleDarkMode.classList.remove("hidden");
                toggleRedMode.classList.remove("hidden");
            }
 });

            toggleRedMode.addEventListener('click', () => {
                if (themeContainer.classList.contains('red-mode')) {
                    themeContainer.classList.remove("red-mode");
                    themeContainer.classList.add("blue-mode");
                }
                else {
                    themeContainer.classList.remove("dark-mode");
                    themeContainer.classList.remove("blue-mode");
                    themeContainer.classList.add("red-mode");
                    toggleRedMode.classList.add("hidden");
                    toggleDarkMode.classList.remove("hidden");
                    toggleBlueMode.classList.remove("hidden");
                }
            });
